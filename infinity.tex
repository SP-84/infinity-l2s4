...
\end{theorem}
\begin{proof}
	Soit \( ((E,<) \) un ensemble bien ordonné. D'après la Proposition 2.1.3, soit \( (E,<) \) est isomorphe à la suite des ordinaux, soit la suite des ordinaux est isomorphe à un segment initial de \( (E,<) \) ou \( (E,<) \) est isomorphe à un segment initial de la suite des ordinaux.
